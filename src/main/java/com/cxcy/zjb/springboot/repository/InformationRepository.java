...
public interface InformationRepository extends JpaRepository<Information,Long> {
     ...
     * @return
     */
    Page<Information> findByInformationCategory(InformationCategory informationCategory, Pageable pageable);
     ...
     * @return
     */
    Page<Information> findByUserAndTitleLike(User user,String title,Pageable pageable);
     ...
     * @return
     */
    Page<Information> findByTitleLikeAndUserOrderByCreateTimeDesc(String title, User user,Pageable pageable);
